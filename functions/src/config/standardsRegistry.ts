import { AuthorityType, HazardDomain } from '@shared/types';

export type GuidelineKind = 'law' | 'official-guidance' | 'voluntary-standard' | 'internal-prototype';
...
export const DOMAIN_REVIEW_AUTHORITY: Record<HazardDomain, AuthorityType> = {
  crowd: 'PDRM',
  venue_fire: 'BOMBA',
