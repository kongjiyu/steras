...
(0, vitest_1.describe)('Admin manual assessment contract and calculation', () => {
    ...
    (0, vitest_1.it)('validates the Admin-owned resource quantities and planning maxima', () => {
        ...
        (0, vitest_1.expect)((0, manualFinalisation_1.validateManualResourcePlan)({ resourcePlan: resources, resourceRationale: 'Admin reviewed capacity, ingress and emergency coverage.' })).toEqual([]);
