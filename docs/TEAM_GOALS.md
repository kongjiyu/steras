...
- Backend aggregation supports required-authority scope and versioned approval/rejection decisions. Event applications have no Amendment decision; a rejected version may be corrected and submitted as a new version under FR-M1-16, while request resubmission is limited to event-control documents.
