...
export const mockEvents: EventRecord[] = [
  ...
  mkEvent({
    ...
    eventDetails: mkEventDetails({
      ...
      description: 'Two-day music festival. Medical station image was reported as inaccurate; M4 investigation confirmed true; resubmission required.',
    }),
  ...
  mkEvent({
    ...
    eventDetails: mkEventDetails({
      ...
      description: 'Charity run for local hospital fund. Stage 2 medical station image was reported but M4 investigation dismissed as fake.',
    }),
    createdAt: daysAgo(90),
    submittedAt: daysAgo(85),
    updatedAt: daysAgo(5),
