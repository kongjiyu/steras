...
export const mockNotifications: Notification[] = [
  ...
  mkNotif({
    ...
    message: 'Control #3 (Medical Station) has been reported by a public viewer as inaccurate. Incident investigation in progress.',
  ...
  mkNotif({
    ...
    message: '"KL Coastal Cleanup Day" Control #3 reported — see incident ticket rep-001-e013-c3-staged-image.',
  ...
  mkNotif({
    ...
    message: 'Control #3 (Medical Station) report outcome applied: the incident investigation confirmed the discrepancy. New Stage 2 upload required.',
  ...
  mkNotif({
    ...
    message: 'Control #3 (Medical Station) report outcome applied: the incident investigation dismissed the report. Document state restored to approved.',
  ...
  mkNotif({
    ...
    notificationType: 'N15_m4_outcome_applied',
    title: 'Incident outcome applied to event control',
    message: 'The system applied the confirmed incident outcome to Control #3 of "Shah Alam Music Fest 2026". You can review or override this change.',
